# Exported environment and $PATH.
#
# The bash/zsh equivalent of this file is ~/.shellrc-common.
# Machine-specific values and overrides belong in conf.d/90-local.fish.
...
# $PATH.
#
# fish_add_path is idempotent, so re-sourcing this file cannot grow $PATH. The
# -g flag keeps the change global rather than universal: a universal
# fish_user_paths would be stored in fish_variables, which this repo
# deliberately no longer manages.
#
# ~/.userenv/path_scripts is gone from this list on purpose - the installer
